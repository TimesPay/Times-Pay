...
class DepositPage extends React.Component<DepositProps, DepositState> {
  ...
  componentWillUnmount() {
    console.log("deposit componentWillUnmount");
  }
  render() {
      ...
      <BasicLayout
        ...
        children={
          <>
            <View
              style={
                this.state.modalVisible ? styles.maskedView : styles.normalView
              }>
              <View style={styles.QRCodeContainer}>
                <QRCode
                  value={`${this.state.address}${this.state.amount && "|"}${this.state.amount}` || 'N/A'}
                />
              </View>
              <Modal
                animationType="slide"
                ...
                <View style={styles.amountModal}>
                  ...
                  <View>
                    <Text
                      ...
                      {translate("deposit_amountConfirm", {})}
                    </Text>
                  </View>
                  <View>
                    <Text
                      ...
                      {translate("deposit_amountUnknown", {})}
                    </Text>
                  </View>
                </View>
              </Modal>
                  ...
                  <Text
                    ...
                    onPress={() => {
                      ...
                      ToastAndroid.showWithGravity(
                        translate('deposit_addressCopied', {}),
                        ToastAndroid.SHORT,
                        ToastAndroid.CENTER,
                      );
                    }}>
              ...
              <View style={styles.otherPaymentButton}>
                <Button
                  onPress={() => {
                    this.setState({
                      amount: 0,
