...
class ExchangePage extends React.Component<ExchangeProps, ExchangeState> {
  ...
  componentDidUpdate() {
    ...
    if (
      !deepCompare(this.state.contract, this.props.exchangeReducer.contract)
    ) {
      this.setState(
        {
          contract: this.props.exchangeReducer.contract,
  ...
  render() {
    console.log(
      'this.state.data',
      (this.state.data.balance / 1000000) * this.state.data.USDToHKD,
    );
    return (
      <>
        <BasicLayout
              ...
              <Card
                ...
                <CardItem
                  ...
                  (this.state.data.USDToHKD !== null &&
                    ...
                    <WalletBox
                      balance={
                        (this.state.data.balance / 1000000) *
                ...
                <CardItem
                  ...
                  {!(
                    this.state.data.gasBalance == null ||
                    this.state.data.gasBalance == undefined
                  ) ? (
                    <WalletBox
