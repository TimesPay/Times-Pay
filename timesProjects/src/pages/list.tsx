...
const Page: NextPage<Props> = (props: Props) => {
	...
	const { data, isValidating } = useSWR(
		shouldRefresh ? "/api/projects" : null,
		(url) =>
			fetcher(url, {
				...defaultOption,
				params: searchParam,
	...
	const headers = [
		{ name: "projName", filterType: "string", align: "left" },
		{ name: "receiver", filterType: "string", align: "center" },
		{ name: "raised", filterType: "quantity", align: "center" },
		{ name: "target", filterType: "quantity", align: "center" },
		{ name: "progress", filterType: "quantity", align: "center" },
		{ name: "createdAt", filterType: "date", align: "center" },
		{ name: "expiredAt", filterType: "date", align: "center" },
	];
					...
					<Table stickyHeader={true}>
						<TableHead>
							...
							>
								...
								>
									{filterSwitchStatus ? <ExpandLessIcon /> : <ExpandMoreIcon />}
								</Button>
							</Grid>
						</TableHead>
						<TableBody>
